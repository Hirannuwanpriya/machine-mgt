      ...
      <DisclosurePanel class="sm:hidden">
        ...
        <div class="border-t border-gray-200 pb-3 pt-4">
          ...
          <div class="mt-3 space-y-1">
            <DisclosureButton @click="logout" class="block px-4 py-2 text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800">Sign Out</DisclosureButton>
          </div>
        </div>
      </DisclosurePanel>
    </Disclosure>
